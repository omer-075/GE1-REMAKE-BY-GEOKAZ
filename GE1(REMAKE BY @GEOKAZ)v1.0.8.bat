@echo off
chcp 65001>nul
title GE1  v1.0.8REMAKE BY @GEOKAZ         (latest update 22/02/2025)   CREDITS!! : @GEOKAZ, @omer_075, @GEBV1, @quatro274 @BTR110, @eboa744 
...
echo %ESC%[32mazerol                [found win key powershell]%ESC%[0m
echo %ESC%[32mpigig                 [cool stuff]%ESC%[0m
echo %ESC%[31maxx                   [chatbox]%ESC%[0m
echo %ESC%[32mpasscrack             [crack admin pass]%ESC%[0m
...
:passcrack
cls
echo       passcrack V1.0.0
echo   1) launch
echo   2) back to main
set /p option="option : "
if "%option%"=="1" goto :passcrack117
if "%option%"=="2" goto :main
pause>nul
exit

:passcrack117
title passcrack with ip/passlist
color A
echo.
...
set /a count=%count%+1
if %errorlevel% EQU 0 goto success12
pause>nul
exit
...
cls
echo.
echo   AZEROL MODDED BY GEOKAZ! (v1.0.2)
echo     1) launch
echo     2) back
set /p option="option : "
if "%option%"=="1" goto :azerolV102
if "%option%"=="2" goto :main
pause>nul
exit
...
echo.
set /p option=""
if "%option%"=="1" goto :launch111110
if "%option%"=="2" goto :STARTazerol
if "%option%"=="3" exit
